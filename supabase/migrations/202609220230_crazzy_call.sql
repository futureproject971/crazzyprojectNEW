...
revoke all on function public.create_call_room(text,integer) from public;
revoke all on function public.get_call_room_preview(text) from public;
revoke all on function public.join_call_room(text,text) from public;
revoke all on function public.get_call_room_snapshot(text) from public;
revoke all on function public.leave_call_room(uuid) from public;
revoke all on function public.set_call_presence(uuid,boolean) from public;
revoke all on function public.set_call_room_locked(uuid,boolean) from public;
revoke all on function public.set_call_participant_role(uuid,uuid,text) from public;
revoke all on function public.kick_call_participant(uuid,uuid) from public;
revoke all on function public.end_call_room(uuid) from public;
revoke all on function public.send_call_message(uuid,text) from public;
